 ...
 *   7 : valid flash method names and properties (there is no type checks sadly, for example String().x will be
 *   highlighted as 'x' is valid, but obviously strings don't have a x property)
